...
import net.dunno.blame.decisions.Attack;
import net.dunno.blame.decisions.Close;
import net.dunno.blame.decisions.Move;
import net.dunno.blame.decisions.Open;
import net.dunno.blame.decisions.Shoot;
import net.dunno.blame.decisions.Take;
import net.dunno.blame.field.Field;
import net.dunno.blame.field.symbols.MainSelector;
import net.dunno.blame.field.symbols.MinorSelector;
