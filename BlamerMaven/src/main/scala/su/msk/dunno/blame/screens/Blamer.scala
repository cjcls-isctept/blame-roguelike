...
object Blamer extends ScageScreen(
  ...
  private lazy val help_screen = new ScageScreen("Help Screen") {
    ...
    interface {
        ...
        print(xml("helpscreen.helpmessage"), 10, (font_size+2), GREEN)
    }
  }
  ...
  windowCenter = Vec((screen_width - right_messages_width)/2,
  ...
  def drawInterface() {
    ...
    print(currentPlayer.stat("name"),             screen_width - right_messages_width, screen_height-25, WHITE)
    ...
    print(xml("mainscreen.stats.health", intStat("health"), intStat("max_health")),
      screen_width - right_messages_width, screen_height-65, WHITE)
    ...
    print(xml("mainscreen.stats.damage", intStat("damage")),
      screen_width - right_messages_width, screen_height-85, WHITE)
    print(xml("mainscreen.stats.energy", intStat("energy"), intStat("max_energy"), intStat("energy_increase_rate")),
      screen_width - right_messages_width, screen_height-105, WHITE)
    print(xml("mainscreen.stats.shield", intStat("shield"), intStat("max_shield"), intStat("shield_increase_rate")),
      screen_width - right_messages_width, screen_height-125, WHITE)
    print(xml("mainscreen.stats.level", intStat("level")), screen_width - right_messages_width, screen_height-145, WHITE)
    print(xml("mainscreen.stats.speed", intStat("speed")), screen_width - right_messages_width, screen_height-165, WHITE)
  } 

  render {
    FieldTracer.drawField(currentPlayer.point)
  }
